...
var servicemodel = new service_1.default();
var orderProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order_id, product_id, quantity, product, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, servicemodel.create({
                        order_id: order_id,
...
var service_routes = function (app) {
    app.post("/service/addProduct", varifyUser_1.default, orderProduct);
};
