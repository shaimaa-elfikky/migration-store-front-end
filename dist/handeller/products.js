...
var productmodel = new products_1.default();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product_name, price, newProducts, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, productmodel.create(product_name, price)];
            case 1:
                newProducts = _a.sent();
...
var products_routes = function (app) {
    ...
    app.post("/products", varifyUser_1.default, create);
};
