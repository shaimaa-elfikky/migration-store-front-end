...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.create = function (product_name, price) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [product_name, price])];
                    case 2:
                        result = _a.sent();
                        console.log(result);
                        conn.release();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("failed to add product with error ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("failed to get product with error ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
