...
var OrderModel = /** @class */ (function () {
    ...
    OrderModel.prototype.create = function (user_id, status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("failed to add order with error ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("failed to get order with error ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
